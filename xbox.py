...
class Joystick:
    ...
    Usage:
        joy = xbox.Joystick()
    """
	whenLeftTrigger = False
	whenRightTrigger = False
	...
	def whenLeftTrigger(self):
		global whenLeftTrigger
		if self.leftTrigger() > 0.2 and not whenLeftTrigger:
			whenLeftTrigger = True
			return True
		elif self.leftTrigger() <= 0.2 and whenLeftTrigger:
			whenLeftTrigger = False
	...
	def whenRightTrigger(self):
		global whenRightTrigger
		if self.rightTrigger() > 0.2 and not whenRightTrigger:
			whenRightTrigger = True
			return True
		elif self.rightTrigger() <= 0.2 and whenRightTrigger:
			whenRightTrigger = False
